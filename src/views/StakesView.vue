...
<template>
  <section class="py-[50px] flex flex-col justify-center h-full">
      <div ref="titleEl" class="container">
        ...
        <p class="font-gilroy text-[28px] leading-tight text-center mt-8 max-sm:text-base">
          ...
          <div class="absolute top-0 left-0 w-full">
            ...
            <source :srcset="userImg3Webp" type="image/webp" />
              <img
                :src="userImg3"
                alt="user_chart"
                class="absolute left-[53%] top-[3%] z-20 w-[110px] h-[110px] max-sm:w-[60px] max-sm:h-[60px] max-sm:top-[5%]"
                loading="lazy"
              />
            </picture>
          </div>
          <div class="absolute top-0 left-0 w-full">
           ...
           <source :srcset="userImg1Webp" type="image/webp" />
              <img
                :src="userImg1"
                alt="user_chart"
                class="absolute left-[28%] top-[10%] z-20 w-[110px] h-[110px] max-sm:w-[60px] max-sm:h-[60px] max-sm:top-[12%] max-sm:left-[40%]"
                loading="lazy"
              />
           </picture>
          </div>
          <div class="absolute top-0 left-0 w-full">
            ...
            <source :srcset="userImg2Webp" type="image/webp" />
              <img
                :src="userImg2"
                alt="user_chart"
                class="absolute left-[68%] top-[25%] z-20 w-[110px] h-[110px] max-sm:w-[60px] max-sm:h-[60px] max-sm:top-[32%] max-sm:left-[52%]"
                loading="lazy"
              />
            </picture>
          </div>
