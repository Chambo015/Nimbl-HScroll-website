<template>
    <section @wheel="onWheel" class="h-full py-14 flex items-center">
        <div class="mx-auto px-9"><h2 ref="titleEl" class="bg-gradient-to-b from-white to-white/50 text-transparent bg-clip-text text-[50px] leading-none font-black uppercase font-rfdewi text-center max-sm:text-2xl">AI research</h2>
        <div class="flex gap-52 mt-24">
            <div ref="leftVideoEl" class="max-w-[650px] mix-blend-lighten">
                ...
                <h3 class="text-[40px] mt-10 font-rfdewi font-bold uppercase">longs to clips</h3>
            ...
            <div ref="rightVideoEl" class="max-w-[650px] mix-blend-lighten"> <div class=" w-[640px] h-[387px] relative">
                    <img :src="frame_video" alt="frame_video" class="w-full h-full mix-blend-lighten pointer-events-none">
                    <VideoPlayer class="absolute top-9 left-9 rounded-xl w-[88%] h-[82%] object-cover" :video-src="video.videoSrc" :subtitles="video.subtitles"  :voice-tracks="video.audioSrc"/>
                    <!-- <picture><source :srcset="imglaunguagesWebp" type="image/webp" /><img loading="lazy" :src="imglaunguages" alt="imgMobileGpt" class=" absolute top-9 left-9 rounded-xl w-[88%] h-[82%] object-cover" /></picture> -->
                </div>
                <h3 class="text-[40px] mt-10 font-rfdewi font-bold uppercase">ai translate</h3>
