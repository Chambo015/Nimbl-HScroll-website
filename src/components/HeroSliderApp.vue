<template>
    <div ref="container" class="keen-slider !w-[1530px] max-sm:!w-full items-center relative mx-auto">
        <div
            :class="[
...
const styles = {
    activeWrap: "!w-[324px] h-[610px] max-sm:w-[225px] max-sm:h-[400px]",
    unActiveWrap: "h-[492px] max-sm:w-[172px] max-sm:h-[320px] !w-[264px]",
    activeImg: "w-[314px] max-sm:w-[204px]",
    unActiveImg: "w-[264px] max-sm:w-[172px]",
};
