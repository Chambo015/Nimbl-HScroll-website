<template>
    <div class="w-[500px] max-md:w-[calc(100vw-40px)]">
        <Tweet tweet-id="1702230452373745826" theme="dark" :width="widthWidget ">
            <template v-slot:loading>
                <div class="w-[500px] h-[590px] max-md:w-[calc(100vw-40px)] max-md:h-[400px] bg-[#15202b] flex items-center justify-center rounded-lg"> <Vue3Lottie animation-link="lottie/loading.json" :height="200" :width="200" /></div>
            </template>
        </Tweet>
    </div>
</template>
